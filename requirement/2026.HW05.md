...
| --- | --- |
| Submission Lecturers & TAs | Moodle (report) Dr. Lam Quang Vu / Dr. Tran Duy Hoang / MSc. Tran Thi |
| Contact | Bich Hanh / MSc. Truong Phuoc Loc / MSc. Ho Tuan Thanh lqvu@fit.hcmus.edu.vn / tdhoang@fit.hcmus.edu.vn / ttbhanh@fit.hcmus.edu.vn / tploc@fit.hcmus.edu.vn / |
|   | hthanh@fit.hcmus.edu.vn |
|   | Open — a declaration and an attached AI Audit Report are |
| AI Policy | mandatory |
|   | G9.1 → G9.6, depending on the homework (see the CLO |
| Required Bloom-AI Level | Mapping) |
